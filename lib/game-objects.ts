...
Find the needle that will never stray.`,
    x: 32,
    y: 54,
    modulePath: "/objects/finalmodule1.html",
  },
  {
    id: "bluetooth",
    name: "Bluetooth",
...
Seek the azure rune where the ghost-signals remain.`,
    x: 11,
    y: 51,
    modulePath: "/objects/finalmodule2.html",
  },
  {
    id: "internet",
...
Find the network connecting you and me.`,
    x: 72,
    y: 20,
    modulePath: "/objects/finalmodule3.html",
  },
  {
    id: "zero",
    name: "Zero",
...
Find me where numbers begin their role.`,
    x: 20,
    y: 71,
    modulePath: "/objects/finalmodule4.html",
  },
  {
    id: "penicillin",
    name: "Penicillium",
...
A tiny savior with stories to tell.`,
    x: 73,
    y: 73,
    modulePath: "/objects/finalmodule5.html",
  },
  {
    id: "radio",
    name: "Radio",
    isDemo: false,
    clue: `An Italian spark sent through the air,
Invisible voices from seemingly nowhere.
No wire or cable to carry the sound,
Find the tuning dial where the waves are bound.`,
    x: 47,
    y: 7,
    modulePath: "/objects/finalmodule6.html",
  },
  {
    id: "airplane",
    name: "Airplane",
    isDemo: false,
    clue: `Neither alive nor born with wing,
Yet higher than migrating things.
It bends the air through force and flame 
Name this triumph over gravity’s claim.`,
    x: 8,
    y: 80,
    modulePath: "/objects/finalmodule7.html",
  },
  {
    id: "sputnik",
    name: "Sputnik",
    isDemo: false,
    clue: `A lonely sphere in endless black,
The first to never journey back.
It sang in beeps through silent space,
A tiny star the world could trace.`,
    x: 82,
    y: 84,
    modulePath: "/objects/finalmodule8.html",
  },
];
